...
Allow to use your own template. Use the default template at templates/index.tmpl as reference.
...
or take a look at the [AngularJS source code](https://github.com/angular/angular.js/tree/master/ng) for more examples.
