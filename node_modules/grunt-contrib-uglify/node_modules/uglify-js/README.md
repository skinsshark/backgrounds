...
For example:
    ...
    uglifyjs /home/doe/work/foo/js/file1.js \
             /home/doe/work/foo/js/file2.js \
             -o foo.min.js \
...
mapping will refer to `http://foo.com/js/file1.js` and
`http://foo.com/js/file2.js` (in fact it will list `http://foo.com/src`
